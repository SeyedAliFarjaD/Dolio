                ...
                <div className="container">
                    <div className="content-text position-relative">
                        <div className="animate-element wow delay5 fadeInDown" data-wow-delay="0.3s">
                            <div className="tag color-d1 mg-b34 head-text"> توسعه‌دهنده فول استک   
 </div>
                            ...
                            <p className="color-d13 lt-sp02 mb-4">
                                از سال 94 کارم رو با برنامه نویسی اندروید در کنار تحصیل رشته کامپیوتر شروع کردم... 
                        ...
                        <div className="animate-element wow delay5 fadeInUp" data-wow-delay="0.3s">
                            <div className="fl-btn btn-general color-s2 btn-hv-border">
                                <Link to="#" className="f-w500 color-d6 border-corner5 lt-sp01 text-two"> دانلود رزومه </Link>
                            </div>
                        </div>
                    </div>
